...
from .models import Post, LikePost, Profile, FollowerCount
...
def profile(request, pk):
    ...
    no_of_followers = len(user_followers)

    user_following = FollowerCount.objects.filter(follower=pk)
    no_of_following = len(user_following)
...
def setting(request):
    ...
    if request.method == 'POST':
        ...
        if request.FILES.get('image') == None:
            ...
            user_profile.profieleimg = image
